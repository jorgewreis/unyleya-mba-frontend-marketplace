      ...
      <section className='title-page'>
        ...
        <form className='my-6'>
            <div className="form-control flex flex-col my-2">
                ...
                <input type="email" id="email" onClick={ clear } className='border border-slate-300 rounded-md py-2 px-6 w-80' required/>
            </div>
            <div className="form-control flex flex-col my-2">
                <label htmlFor="senha" className='pl-2 pb-1 text-sm text-gray-500'>Senha</label>
                <input type="password" id="senha" className='border border-slate-300 rounded-md py-2 px-6 w-80' required/>
            </div>
